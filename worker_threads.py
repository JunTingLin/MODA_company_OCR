...
from file_management import (
    clear_directory, copy_files_to_output_folder, remove_pdf_files_from_folder,
...
class WorkerThread(QThread):
    ...
    def __init__(self, file_paths, output_folder_path, updater, unified_number=None, archive=False, call_api=False, rename_files=False, summary=False, company_name_en=None):
        ...
        self.summary_data_output_json_path = os.path.join(self.output_folder_path, 'summary.json')
    ...
    def run(self):
        try:
            ...
            updated_filenames = process_pdf_folder(self.output_folder_path, updated_filenames, self.updater)
            ...
            processed_data = add_checkbox_status_to_data(processed_data, self.output_folder_path)

            self.updater.update_status("正在添加qr_codes_links...")
            processed_data = add_qr_codes_links_to_data(processed_data, self.output_folder_path)
            ...
            if self.rename_files:
                ...
                rename_file_by_code(self.output_json_path, self.output_folder_path)
